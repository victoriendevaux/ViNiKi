...
public class GPSLocalisationService extends Service {
    ...
    public void onCreate() {
        ...
        BatterieService batterieService = new BatterieService();

        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, batterieService.changementRafraichissement(GlobalVariable.getInstance().getConnectedUtilisateur().getFrequenceDeplacement()), 0, listener);
    }
